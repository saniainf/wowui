...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["tergetEliteDragon"] = {
			...
			["texture"] = "Interface\\AddOns\\UI\\elitedragon",
			["selfPoint"] = "CENTER",
			["trigger"] = {
				["subeventPrefix"] = "SPELL",
				["debuffType"] = "HELPFUL",
		...
		["TargetPanel"] = {
			...
			["controlledChildren"] = {
				...
				"targetClassLvl", -- [3]
				"targetHealtText", -- [4]
				"targetHealtPercent", -- [5]
				"targetPowerText", -- [6]
				"targetPowerPercent", -- [7]
				"targetHealtBar", -- [8]
				"targetPowerBar", -- [9]
				"targetPanelMouseArea", -- [10]
			},
			["borderBackdrop"] = "Blizzard Tooltip",
			["disjunctive"] = "all",
			["border"] = false,
